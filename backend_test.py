...
class PolymarketEdgeOSApiTester:
    def __init__(self, base_url: str = "https://arb-engine-live-1.preview.emergentagent.com"):
...
def main():
    ...
    base_url = os.getenv('BACKEND_URL', 'https://arb-engine-live-1.preview.emergentagent.com')
