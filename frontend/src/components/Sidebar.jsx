...
import {
  ...
  ShieldAlert, BarChart3, Settings, Crosshair, Wifi, WifiOff, TrendingUp
} from 'lucide-react';

const ICONS = { LayoutDashboard, ArrowLeftRight, Layers, ShieldAlert, BarChart3, Settings, Crosshair, TrendingUp };
